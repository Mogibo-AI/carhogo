...
**関連ドキュメント**:
- [ユーザーストーリー詳細](../user-stories/stories.md) — 各ストーリーの Gherkin 受け入れ基準・サンプルダイアログ
- [ユニット・オブ・ワーク定義](./unit-of-work.md) — 各ユニットのディレクトリ構成・責務・開発フェーズ
- [ユニット依存関係](./unit-of-work-dependency.md) — ユニット間の依存関係・ビルド順序
